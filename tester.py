"""
Utility script for testing solutions under user set conditions.
"""
import time
import argparse
import subprocess
...
LOGGER = back.logging.get_logger("back-tester")
if ARGS.verbose:
...
INPUT_LEN, INPUT_HASH = back.utils.file_summary(INPUT_PATH)
...
RECV_LEN, RECV_HASH = back.utils.file_summary(RECV_PATH)
